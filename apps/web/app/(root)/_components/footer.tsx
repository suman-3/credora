...
export default function FooterSection() {
    return (
        <footer className="w-full flex max-w-screen-2xl mx-auto flex-col items-center justify-center overflow-hidden px-5 md:px-14 py-10">
            <div className="mx-auto w-full px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 lowercase">
                    <Link
                        href="#"
                        target="_blank"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} credora, All rights reserved</span>
            </div>
        </footer>
    )
}